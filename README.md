...
2.	We are generating heatmap dynamically after every 25 frames by converting stored heatmap points into arrays and creating and plotting a 2D density heatmap.
...
2.	Notification service is also implemented when the crowd density goes severe based on the set threshold. In this prototype the we had used Adafruit.io and IFTTT for notification.
